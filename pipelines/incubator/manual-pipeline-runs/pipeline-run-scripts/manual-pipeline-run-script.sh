...
PIPELINE_RESOURCE_FILE=https://raw.githubusercontent.com/kabanero-io/kabanero-pipelines/master/pipelines/incubator/manual-pipeline-runs/pipeline-resources/pipeline-resources-template.yaml
...
PIPELINE_RUN_MANUAL_FILE=https://raw.githubusercontent.com/kabanero-io/kabanero-pipelines/master/pipelines/incubator/manual-pipeline-runs/pipeline-runs/manual-pipeline-run-template.yaml
